    ...
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-20 backdrop-blur bg-bg/85 border-b border-line">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <a href="/" className="opacity-90 hover:opacity-100 transition" aria-label="Zur Startseite">
          ...
          <div className="font-mono text-[10px] tracking-widest uppercase text-ink-dim">
      ...
      {/* Step Title */}
      <div className="max-w-5xl mx-auto px-6 pt-12 w-full" key={`title-${currentStep}`}>
        <p
          className="font-mono text-[10px] tracking-[0.2em] uppercase text-accent mb-3 rise"
          style={{ animationDelay: "0ms" }}
        >
          {String(stepIdx + 1).padStart(2, "0")} · AVV nach Art. 28 DSGVO
        </p>
        <h1
        ...
        <p className="text-ink-dim mt-3 text-lg rise" style={{ animationDelay: "80ms" }}>
          {meta.sub}
        </p>
      </div>
