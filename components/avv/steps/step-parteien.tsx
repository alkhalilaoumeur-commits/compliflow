...
const SERVICE_PRESETS: Record<string, ServicePreset> = {
  ...
  "Zoom": {
    firma: "Zoom Video Communications, Inc.",
    strasse: "55 Almaden Blvd, Suite 600",
    plz: "95113",
    ort: "San Jose, CA",
    land: "USA",
  ...
  "Notion": {
    firma: "Notion Labs, Inc.",
    strasse: "2300 Harrison St",
    plz: "94110",
  ...
  "HubSpot": {
    firma: "HubSpot, Inc.",
    strasse: "25 First Street, 2nd Floor",
    plz: "02141",
    ort: "Cambridge, MA",
    land: "USA",
  ...
  "Calendly": {
    firma: "Calendly LLC",
    strasse: "271 17th St NW, Suite 1000",
    plz: "30363",
    ort: "Atlanta, GA",
    land: "USA",
    email: "privacy@calendly.com",
  },
  "Lexoffice": {
    firma: "Haufe-Lexware GmbH & Co. KG",
    strasse: "Munzinger Straße 9",
    plz: "79111",
    ort: "Freiburg im Breisgau",
    land: "Deutschland",
    email: "datenschutz@haufe-lexware.com",
  },
  "Typeform": {
    firma: "TYPEFORM S.L.",
    strasse: "Carrer Bac de Roda 163",
    plz: "08018",
    ort: "Barcelona",
    land: "Spanien",
    email: "privacy@typeform.com",
  },
};
