...
// Node-Runtime für Hetzner/Coolify-Kompatibilität (Edge funktioniert nicht in Standalone-Server).
export const alt = "Compliflow AVV-Generator — DSGVO-konform in 2 Minuten";
