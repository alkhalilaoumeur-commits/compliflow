...
Sie müssen für einen etwaigen Wertverlust der Waren nur aufkommen, wenn dieser Wertverlust auf einen zur Prüfung der Beschaffenheit, Eigenschaften und Funktionsweise der Waren nicht notwendigen Umgang mit ihnen zurückzuführen ist.`,
  ...
  folgen_rueckzahlung: `Wenn Sie diesen Vertrag widerrufen, haben wir Ihnen alle Zahlungen, die wir von Ihnen erhalten haben, einschließlich der Lieferkosten (mit Ausnahme der zusätzlichen Kosten, die sich daraus ergeben, dass Sie eine andere Art der Lieferung als die von uns angebotene, günstigste Standardlieferung gewählt haben), unverzüglich und spätestens binnen vierzehn Tagen ab dem Tag zurückzuzahlen, an dem die Mitteilung über Ihren Widerruf dieses Vertrags bei uns eingegangen ist. Für diese Rückzahlung verwenden wir dasselbe Zahlungsmittel, das Sie bei der ursprünglichen Transaktion eingesetzt haben, es sei denn, mit Ihnen wurde ausdrücklich etwas anderes vereinbart; in keinem Fall werden Ihnen wegen dieser Rückzahlung Entgelte berechnet.`,

  folgen_dienstleistung_anteil: `Haben Sie verlangt, dass die Dienstleistungen während der Widerrufsfrist beginnen sollen, so haben Sie uns einen angemessenen Betrag zu zahlen, der dem Anteil der bis zu dem Zeitpunkt, zu dem Sie uns von der Ausübung des Widerrufsrechts hinsichtlich dieses Vertrags unterrichten, bereits erbrachten Dienstleistungen im Vergleich zum Gesamtumfang der im Vertrag vorgesehenen Dienstleistungen entspricht.`,
  ...
  fristverlaengerung_hinweis: `**Hinweis zur Widerrufsfrist:** Sollten wir Sie nicht ordnungsgemäß über Ihr Widerrufsrecht belehrt haben, erlischt Ihr Widerrufsrecht spätestens zwölf Monate und 14 Tage nach dem oben beschriebenen Fristbeginn (§ 356 Abs. 3 BGB).`,
...
— An {{ANBIETER_NAME}}, {{ANBIETER_ADRESSE}}, E-Mail: {{ANBIETER_EMAIL}}{{ANBIETER_FAX}}:
...
Das Widerrufsrecht nach §§ 312g, 355 BGB steht ausschließlich Verbrauchern im Sinne des § 13 BGB zu. Da der Vertrag mit Ihnen als Unternehmer im Sinne des § 14 BGB geschlossen wird, besteht KEIN gesetzliches Widerrufsrecht.`,
  ...
  // Hinweis bei (Teil-)Ausschluss einzelner Waren/Leistungen
  ausschluss_hinweis: `## Hinweis zum Ausschluss des Widerrufsrechts

Für die folgenden Waren bzw. Leistungen besteht kein Widerrufsrecht oder das Widerrufsrecht erlischt vorzeitig:`,
};
